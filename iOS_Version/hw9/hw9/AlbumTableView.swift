...
var pictureUrl = ""
    ...
    // MARK: - Table view data source
     ...
     func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        if AlbumJSon.count > 0{
            return AlbumJSon.count
        }
        return 1
    }
     ...
     func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if AlbumJSon.count == 0{
            print("last user ablbum cell")
            cell.albumNameCell.text = "No data found"
            return cell
        }
        
        if let albumNameCell = AlbumJSon[indexPath.row]["name"].string{
            cell.albumNameCell.text = albumNameCell
        }

        if let albumPicCell1 = AlbumJSon[indexPath.row]["photos"]["data"][0]["picture"].string{
        ...
        if let albumPicCell2 = AlbumJSon[indexPath.row]["photos"]["data"][1]["picture"].string{
